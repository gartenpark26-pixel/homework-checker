...
const MAP_SQUARES = [
  ...
  /* sq 10 큰나무 (랜드마크) */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#22C55E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="9" r="6" fill="#22C55E" fill-opacity="0.2"/><circle cx="12" cy="9" r="6"/><line x1="12" y1="15" x2="12" y2="21"/><line x1="9" y1="20" x2="15" y2="20"/></svg>', label: '큰나무', bg: '#E0F7E9' },
  ...
  /* sq 19 왕관 */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#FCD34D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18h18M3 18l2-8 4.5 4L12 6l2.5 8L19 10l2 8" fill="#FCD34D" fill-opacity="0.1"/><circle cx="12" cy="6" r="1" fill="#FCD34D" stroke="none"/><circle cx="3" cy="18" r="1" fill="#FCD34D" stroke="none"/><circle cx="21" cy="18" r="1" fill="#FCD34D" stroke="none"/></svg>', label: '왕관', bg: '#FFFFFF' },
  /* sq 20 동화성 (랜드마크) */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#A855F7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="13" width="18" height="8" rx="1" fill="#A855F7" fill-opacity="0.1"/><rect x="3" y="13" width="18" height="8" rx="1"/><rect x="5" y="9" width="4" height="5"/><rect x="10" y="7" width="4" height="7"/><rect x="15" y="9" width="4" height="5"/><path d="M6 9V6l1.5-2L9 6v3"/><path d="M11 7V4l1.5-2L14 4v3"/><path d="M16 9V6l1.5-2L19 6v3"/><rect x="10" y="17" width="4" height="4"/></svg>', label: '동화성', bg: '#F3E5F5' },
  ...
  /* sq 29 반짝임 */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#E879F9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5z" fill="#E879F9" fill-opacity="0.1"/><path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5z"/><path d="M19 17l.7 2.3 2.3.7-2.3.7-.7 2.3-.7-2.3-2.3-.7 2.3-.7z" stroke-width="1"/></svg>', label: '반짝임', bg: '#FFFFFF' },
  /* sq 30 분수대 (랜드마크) */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#38BDF8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="20" rx="8" ry="2" fill="#38BDF8" fill-opacity="0.1"/><ellipse cx="12" cy="20" rx="8" ry="2"/><ellipse cx="12" cy="15.5" rx="4" ry="1.5"/><line x1="12" y1="15.5" x2="12" y2="20"/><path d="M9 14c1-4 2-6 3-7"/><path d="M15 14c-1-4-2-6-3-7"/><path d="M7 12c2-5 4-7 5-5"/><path d="M17 12c-2-5-4-7-5-5"/></svg>', label: '분수대', bg: '#E3F2FD' },
  ...
  /* sq 35 마법봉 */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#E879F9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="18" x2="18" y2="6"/><path d="M18 6l1.5-2 1.5 1.5-2 1.5z" fill="#E879F9" fill-opacity="0.3"/><circle cx="5" cy="5" r="1" fill="#E879F9" stroke="none"/><circle cx="19" cy="5" r="0.8" fill="#FCD34D" stroke="none"/><circle cx="19" cy="11" r="0.8" fill="#86EFAC" stroke="none"/><circle cx="13" cy="5" r="0.8" fill="#93C5FD" stroke="none"/></svg>', label: '마법봉', bg: '#FFFFFF' },
  ...
  /* sq 39 도착전야 */ { emoji: '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="#F59E0B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5z" fill="#F59E0B" fill-opacity="0.2"/><path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5z"/><path d="M19 17l.7 2.3 2.3.7-2.3.7-.7 2.3-.7-2.3-2.3-.7 2.3-.7z" stroke-width="1" stroke="#F59E0B"/><path d="M5 4l.5 1.5L7 6l-1.5.5L5 8l-.5-1.5L3 6l1.5-.5z" stroke-width="1" stroke="#F59E0B"/></svg>', label: '도착전야', bg: '#FFFFFF' },
];
...
function _buildBoard(sihTotal, sionTotal) {
  ...
  for (let r = 0; r < 11; r++) {
    for (let c = 0; c < 11; c++) {
      ...
      if (!isOuter) {
        if (r === 1 && c === 1) {
          html.push(
            ...
            '<div class="map-inner-tracks"></div>' +
            '<div class="map-inner-info">' +
            `<div class="map-inner-card sih-card"><span class="map-inner-tok">🐰</span><span class="map-inner-name">시현이</span><span class="map-inner-pt" id="inner-sih-pt">${mapPts['시현이']}pt</span></div>` +
            `<div class="map-inner-card sio-card"><span class="map-inner-tok">🐻</span><span class="map-inner-name">시온이</span><span class="map-inner-pt" id="inner-sio-pt">${mapPts['시온이']}pt</span></div>` +
            '</div>' +
            '</div>'
          );
        }
      ...
      // 엣지 방향 및 선로 클래스
      let edgeCls, trackCls;
      if (r === 0)       { edgeCls = 'map-et'; trackCls = 'track-h'; }
      else if (c === 10) { edgeCls = 'map-er'; trackCls = 'track-v'; }
      else if (r === 10) { edgeCls = 'map-eb'; trackCls = 'track-h'; }
      else               { edgeCls = 'map-el'; trackCls = 'track-v'; }

      // 코너 클래스
      const isCorner = (r === 0 && c === 0) || (r === 0 && c === 10) ||
                       (r === 10 && c === 0) || (r === 10 && c === 10);
      if (isCorner) trackCls = 'track-corner';

      const tok = (sih ? '<span class="map-tok sih-tok" title="시현이">🐰</span>' : '')
                + (sio ? '<span class="map-tok sio-tok" title="시온이">🐻</span>' : '');

      html.push(
        `<div class="map-cell map-cs ${edgeCls} ${trackCls}${isLandmark ? ' map-lm' : ''}${sq === 0 ? ' map-start' : ''}` +
